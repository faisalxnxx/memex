...
\033[1;91m  ____                         __        __    
 ...
 \___ \| '_ \ / _` | '_ ` _ \   \ \ /\ / / _` |
\033[1;37m  ___) | |_) | (_| | | | | | |   \ V  V / (_| |
 |____/| .__/ \__,_|_| |_| |_|    \_/\_/ \__,_|
       |_|                                     
                   '''+W+'\033[1;91m(\033[1;37mAuthor\033[1;91m) \033[1;92m: \033[1;37mM_aref\n\t\t   \033[1;91m(\033[1;37mYoutub\033[1;91m) \033[1;92m: \033[1;37mThe-X-Cyber\n\t\t        \033[1;92mversi \033[1;37m9.9')
...
def RupaRupa():
	...
	MesinTik(W+'\t================')
	print
	number = raw_input(''+C+'\033[1;37mNOMOR TARGET'+W+' ('+H+' Ex :'+C+' 0812xxxx '+W+') : ')
	jumlah = input(''+C+'\033[1;34mJUMLAH SPAM'+W+' ('+H+' Ex :'+C+' 3 '+W+') : ')
	print
	...
	for x in range(jumlah):
		try:
			...
			if 'tunggu 4x1 jam' in sending_2.text:
				print
				print(''+W+'Pengiriman Sudah Limit\nSilahkan Coba 4 x 1 Jam Lagi :)')
				break
...
def Tokped():
	...
	for x in range(jumlah):
		try:
			...
			if 'Anda sudah melakukan 4 kali pengiriman kode' in sending.text:
				print
				print(''+W+'Pengiriman Sudah Limit\nSilahkan Coba 3 - 6 Menit Lagi :)')
				break
...
def Spam():
	os.system('clear')
	print(C+'\033[1;33mSubscribe YT'+W+'Gua Dlu Su !'+C+' :V')
	sleep(1.5)
	...
	print(C+'\t['+W+'2'+C+']'+W+' SPAM RUPA-RUPA'+C+' ( '+H+'Aktif'+C+' )')
	print
	
	try:
		
		pilih = input(W+'Thex'+W+' \xE2\x9E\xA4 '+C+'')
		if pilih == 1:
			Tokped() 
		elif pilih == 2:
			RupaRupa()
